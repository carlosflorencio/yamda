...
public class YamdaApplication extends Application {
    ...
    */
    ...
    public void initPeriodicUpdates() {
        ...
        int soonDays = Integer.parseInt(sharedPreferences.getString(getResources().getString(R.string.soon_periodicity), "7"));
    ...
    public void refreshSoonAlarm(int days){
        Intent intent = new Intent(this, SoonListService.class);
        setAlarm(intent, days, PendingIntent.FLAG_CANCEL_CURRENT);
    }

...
public final class MovieDetails implements Parcelable {
    ...
    public MovieDetails(int id, String title, String release_date, float rating, int voteCount,
                        int runtime, String overview,
                        String poster, String backdrop, Genre[] genres, String homepage,
